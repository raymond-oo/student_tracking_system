(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.createEarthoOne = factory());
    ...
    */
    ...
    class EarthoOne {
        constructor(options) {
            this.issuer = 'https://one.eartho.world/';
        ...
        getVerifiedUser(idToken) {
            return __awaiter(this, void 0, void 0, function* () {
                return jose.importSPKI(this.clientSecret, "RS256", {})
                    .then((publicKJwk) => jose.jwtVerify(idToken, publicKJwk, {
                    audience: this.clientId,
                    issuer: this.issuer,
                })).then(function (x) {
                    return x.payload.user;
                });
            });
        }
    }
    ...
    *
     ...
     */
    function createEarthoOne(options) {
        return __awaiter(this, void 0, void 0, function* () {
...
('earthoOne' in this) && this.console && this.console.warn && this.console.warn('earthoOne already declared on the global namespace');
this && this.createEarthoOne && (this.earthoOne = this.earthoOne || this.createEarthoOne.earthoOne);
//# sourceMappingURL=eartho-one-server-node.development.js.map
